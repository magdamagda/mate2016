...
class Buttons(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.addButton(layout, "Manipulator", lambda: self.execProgram([sys.executable, 'motorsmanipulator/manipulatorsMain.py']))
        self.addButton(layout, "Motors", lambda: self.execProgram([sys.executable, 'motorsmanipulator/motorsMain.py']))
